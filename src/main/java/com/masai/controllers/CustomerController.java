   ...
   AccountServicesIntr accountServicesIntr;
	...
	private CustomerLoginImpl customerLogin;
	  ...
	  // for user Login
		...
		public ResponseEntity<Beneficiary> deleteBenificiaryHandler(@Valid @RequestParam String mobileNo , @RequestParam String key) {
			
			Beneficiary b = bService.removeBenificiary(mobileNo, key);
		  return new ResponseEntity<Beneficiary>(b,HttpStatus.CREATED);
